...
String updateIndex = 
  ...
  "</style>"
  "<form method='POST' action='/doupdate' enctype='multipart/form-data' style='text-align:center;' onsubmit='showWait()'>"
  ...
  "<p style='font-size:0.8em;color:#aaaaaa;'>Let's build geeky things</p>"
  "<h5>F4992-ESP32S3 turntable controller Firmware update</h5>"
